...
class _EditDetailsState extends State<EditDetails> {
  ...
  void didChangeDependencies() {
    if (isinit) {
      ...
      _initvalues['name'] = _editedUserDetails['name'];
      _initvalues['userid'] = _editedUserDetails['userID'];
      _initvalues['contact'] = _editedUserDetails['phone'];
      _initvalues['password'] = _editedUserDetails['password'];
      _initvalues['cfnpass'] = _editedUserDetails['password'];
      _initvalues['address'] = _editedUserDetails['address'];
      _initvalues['gender'] = _editedUserDetails['gender'];
    }
    isinit = false;
  ...
  Widget textfield(String initname, bool auth, String label,
    ...
    if (initname == 'cfnpass' || initname == 'password') {
      return Row(
        children: <Widget>[
          Expanded(
            child: TextFormField(
                          ...
                          textfield(
                            ...
                            (value) {
                              _editedUserDetails = {
                                ...
                                'address': _editedUserDetails['address']
                              };
                            },
                          ),
                          SizedBox(
